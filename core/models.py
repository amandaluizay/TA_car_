...
class Mensalista(models.Model):
    ...
    forma_pagamento = models.ForeignKey(Forma_Pagamento, on_delete=models.CASCADE, verbose_name='Forma de pagamento',
                                        blank=True, null=True)
    total = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True,
                                verbose_name="Valor com desconto")
